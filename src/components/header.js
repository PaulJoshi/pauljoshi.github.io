...
const Header = ({ siteTitle }) => {
  ...
  return <header className="fixed w-full flex flex-wrap items-center px-4 pt-4 lg:px-24 lg:pt-8 text-primaryText-50">
    ...
    <div
      ...
      <nav
      className={navHover ? "absolute md:static left-0 lg:px-20 w-full lg:w-auto text-3xl md:text-6xl" : "hidden absolute md:static left-0 lg:px-20 w-full lg:w-auto text-3xl md:text-5xl"}
      id="navigation">
        <div className="bg-green-500 divide-y flex flex-col md:bg-transparent md:flex-row md:divide-y-0 ">
